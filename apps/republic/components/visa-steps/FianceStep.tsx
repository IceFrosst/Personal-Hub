    ...
    <StepShell visa={visa}>
      ...
      {!done ? (
        ...
        <div className="animate-fade-in text-center">
          <p className="font-stamp text-lg uppercase tracking-wide text-approve">{FIANCE_RESULT.title}</p>
          <p className="mt-2 text-[11px] uppercase text-navy/60">{FIANCE_RESULT.note}</p>
          <button
            type="button"
